...
def build_low_net(minimap, screen, info, dir_high, act_id):
  ...
  with tf.variable_scope('actor_low'):
      ...
      # spatial_action_low = layers.flatten(spatial_action_low)
      # spatial_action_low = tf.concat([spatial_action_low, dir_high, act_id], axis=1)
      # spatial_action_low = tf.nn.softmax(spatial_action_low)
      #

...
# tmp0 = np.load('./DataForAnalysis/victory_or_defeat_thread0episode1.npy')
# tmp1 = np.load('./DataForAnalysis/victory_or_defeat_thread1episode1.npy')
# tmp2 = np.load('./DataForAnalysis/victory_or_defeat_thread2episode1.npy')
# tmp3 = np.load('./DataForAnalysis/victory_or_defeat_thread3episode1.npy')
